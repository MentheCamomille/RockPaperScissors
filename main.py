...
def play_best_of(n):
    # play against the computer until wins best of n games
    ...
    while player_wins < wins_necessary and computer_wins < wins_necessary:
        ...
        # tie
        if result == 0:
            print('It is a tie. You and the computer have bothe chosen {}. \n'.format(user))
        # you win
        elif result == 1:
            player_wins += 1
    ...
    if player_wins > computer_wins:
        print('You have won the best of {} games! What a camp :D'.format(n))
    else:
